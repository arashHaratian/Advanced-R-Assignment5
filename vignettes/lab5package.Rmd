...
The `get_politicians_data()`calls the `dataset_query()` and the `years_function()` and ultimately returns a `data.frame` containing the columns we want to extract from the original data, plus an additional column with the years that politician has been working.  
